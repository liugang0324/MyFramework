...
public class FragMenuNotify extends BaseFragment<FragCommendPresenter> implements FragCommendView, View
        .OnClickListener {
    ...
    protected void initData() {
        ...
        mMenuoneTitleRight.setText("");
        mMenuoneTitleCenter.setText("消息通知");
    }
